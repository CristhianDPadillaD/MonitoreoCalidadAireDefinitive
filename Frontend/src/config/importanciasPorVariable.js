const importanciasPorVariable = {
  ...
  temperatura: "La temperatura influye directamente en la salud humana y en la dispersión de contaminantes. Valores extremos pueden afectar la calidad del aire y el bienestar general.",
  presion: "La presión atmosférica está relacionada con las condiciones meteorológicas. Cambios bruscos pueden influir en el comportamiento de contaminantes y afectar la salud cardiovascular."
};

export default importanciasPorVariable;
